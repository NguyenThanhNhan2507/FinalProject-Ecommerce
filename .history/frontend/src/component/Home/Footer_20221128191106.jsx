    ...
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        ...
        <div className="location flex py__10">
          ...
          <h6>97 Ly Thuong Kiet,Hoi An</h6>
        </div>
      ...
      <div className="location flex py__10">
        ...
        <div className="footer__2nd__part">
             ...
             <Link style={{color: "white"}} to="/facebook.com"><h3>Facebook</h3></Link>
             <Link style={{color: "white"}} to="/youtube.com"><h3>Youtube</h3></Link>
             <Link style={{color: "white"}} to="/instagram.com"><h3>Instagram</h3></Link>
        </div>
      {/* Footer 4th part */}
