...
const { getAllProduct, taoSanPham, xemSanPham, capNhatSanPham, xoaSanPham, xemXetSanPham, danhGiaSanPham, danhGiaOneSanPham } = require('../controllers/ProductContrl');
...
router.route('/review').get(danhGiaOneSanPham)
