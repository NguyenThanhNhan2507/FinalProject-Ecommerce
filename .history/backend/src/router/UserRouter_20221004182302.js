...
const { taoNguoidung, nguoiDungDangNhap, nguoiDungDangXuat, quenPassword, layLaiMatKhau, thongTinNguoiDung, capNhatMatKhau, capNhatThongTin } = require('../controllers/UserContrl');
...
router.route("/me/update/information").put(xacThucNguoiDung, capNhatMatKhau, capNhatThongTin)
